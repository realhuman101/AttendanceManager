...
namespace Server.Data
{
    public static class Seed
    {
        public static void SeedData(DataContext context)
        {
            ...
            context.ClassLists.Add(new ClassList { Person = person1, Class = class1 });
            context.ClassLists.Add(new ClassList { Person = person1, Class = class2 });
            context.ClassLists.Add(new ClassList { Person = person2, Class = class2 });
            context.ClassLists.Add(new ClassList { Person = person3, Class = class3 });
        }
    }
}
